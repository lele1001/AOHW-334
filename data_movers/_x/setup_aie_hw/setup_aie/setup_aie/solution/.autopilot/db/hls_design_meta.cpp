...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_TDATA", 128, hls_out, 4, "axis", "out_data", 1),
	Port_Property("s_TVALID", 1, hls_out, 4, "axis", "out_vld", 1),
	Port_Property("s_TREADY", 1, hls_in, 4, "axis", "out_acc", 1),
...
const char* HLS_Design_Meta::dut_name = "setup_aie";
