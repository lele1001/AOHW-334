...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MEMORY_NUM_READ_OUTSTANDING"
  ipgui::add_param $IPINST -name "MEMORY_BURST_LENGTH"
  ipgui::add_param $IPINST -name "MEMORY_ARPROT"
  ipgui::add_param $IPINST -name "MEMORY_ARCACHE"
...
proc update_PARAM_VALUE.MEMORY_ARCACHE { PARAM_VALUE.MEMORY_ARCACHE } {
	# Procedure called to update MEMORY_ARCACHE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MEMORY_ARCACHE { PARAM_VALUE.MEMORY_ARCACHE } {
	# Procedure called to validate MEMORY_ARCACHE
	return true
}

proc update_PARAM_VALUE.MEMORY_ARPROT { PARAM_VALUE.MEMORY_ARPROT } {
	# Procedure called to update MEMORY_ARPROT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MEMORY_ARPROT { PARAM_VALUE.MEMORY_ARPROT } {
	# Procedure called to validate MEMORY_ARPROT
	return true
}
...
proc update_MODELPARAM_VALUE.MEMORY_ARPROT { MODELPARAM_VALUE.MEMORY_ARPROT PARAM_VALUE.MEMORY_ARPROT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MEMORY_ARPROT}] ${MODELPARAM_VALUE.MEMORY_ARPROT}
}

proc update_MODELPARAM_VALUE.MEMORY_ARCACHE { MODELPARAM_VALUE.MEMORY_ARCACHE PARAM_VALUE.MEMORY_ARCACHE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MEMORY_ARCACHE}] ${MODELPARAM_VALUE.MEMORY_ARCACHE}
}
