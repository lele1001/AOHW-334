...
#define AUTOTB_TVIN_size "../tv/cdatafile/c.sink_from_aie.autotvin_size.dat"
#define AUTOTB_TVOUT_size "../tv/cdatafile/c.sink_from_aie.autotvout_size.dat"
...
extern "C"
void sink_from_aie_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_sink_from_aie_hw(void* __xlx_apatb_param_input_stream, void* __xlx_apatb_param_output_r, hls::sim::Byte<4> __xlx_apatb_param_size)
{
  ...
  try {
    ...
    sink_from_aie_hw_stub_wrapper(__xlx_apatb_param_input_stream, __xlx_apatb_param_output_r, __xlx_apatb_param_size);
