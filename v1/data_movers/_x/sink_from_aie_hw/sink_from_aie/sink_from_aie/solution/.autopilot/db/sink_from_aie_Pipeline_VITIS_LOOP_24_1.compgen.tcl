...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_stream_TVALID { I 1 bit } input_stream_TDATA { I 32 vector } input_stream_TREADY { O 1 bit } } \
} "
} else {
...
set InstName sink_from_aie_flow_control_loop_pipe_sequential_init_U
set CompName sink_from_aie_flow_control_loop_pipe_sequential_init
