...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_TREADY { I 1 bit } s_TDATA { O 128 vector } s_TVALID { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_size_loop \
    op interface \
    ports { size_loop { I 31 vector } } \
} "
}
...
set InstName setup_aie_flow_control_loop_pipe_sequential_init_U
set CompName setup_aie_flow_control_loop_pipe_sequential_init
