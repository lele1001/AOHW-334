...
set hasInterrupt 0
set C_modelName {setup_aie}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 128 regular {axi_master 0}  }
	{ num_clusters int 32 regular {axi_slave 0}  }
	{ num_points int 32 regular {axi_slave 0}  }
	{ input_r int 64 regular {axi_slave 0}  }
	{ s int 128 regular {axi_s 1 volatile  { s Data } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "num_clusters", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "num_points", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "input_r", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":32}, "offset_end" : {"in":43}} , 
...
set portList { 
	...
	{ s_TDATA sc_out sc_lv 128 signal 4 } 
	{ s_TVALID sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"setup_aie","role":"start","value":"0","valid_bit":"0"},{"name":"setup_aie","role":"continue","value":"0","valid_bit":"4"},{"name":"setup_aie","role":"auto_start","value":"0","valid_bit":"7"},{"name":"num_clusters","role":"data","value":"16"},{"name":"num_points","role":"data","value":"24"},{"name":"input_r","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"setup_aie","role":"start","value":"0","valid_bit":"0"},{"name":"setup_aie","role":"done","value":"0","valid_bit":"1"},{"name":"setup_aie","role":"idle","value":"0","valid_bit":"2"},{"name":"setup_aie","role":"ready","value":"0","valid_bit":"3"},{"name":"setup_aie","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_setup_aie_Pipeline_VITIS_LOOP_37_1_fu_125", "Port" : "gmem0", "Inst_start_state" : "74", "Inst_end_state" : "75"}]},
			...
			{"Name" : "s", "Type" : "Axis", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_setup_aie_Pipeline_VITIS_LOOP_37_1_fu_125", "Port" : "s", "Inst_start_state" : "74", "Inst_end_state" : "75"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_setup_aie_Pipeline_VITIS_LOOP_37_1_fu_125", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "setup_aie_Pipeline_VITIS_LOOP_37_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "size_loop", "Type" : "None", "Direction" : "I"},
			{"Name" : "s", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "s_TDATA_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_setup_aie_Pipeline_VITIS_LOOP_37_1_fu_125.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
...
set ArgLastReadFirstWriteLatency {
	...
	setup_aie_Pipeline_VITIS_LOOP_37_1 {
		gmem0 {Type I LastRead 1 FirstWrite -1}
		sext_ln37 {Type I LastRead 0 FirstWrite -1}
		size_loop {Type I LastRead 0 FirstWrite -1}
		s {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	...
	s { axis {  { s_TDATA out_data 1 128 }  { s_TVALID out_vld 1 1 }  { s_TREADY out_acc 0 1 } } }
}
