...
// ==============================================================
`timescale 1ns/1ps
module setup_aie_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                 = 6'h08,
    ADDR_ISR                 = 6'h0c,
    ADDR_NUM_CLUSTERS_DATA_0 = 6'h10,
    ADDR_NUM_CLUSTERS_CTRL   = 6'h14,
    ADDR_NUM_POINTS_DATA_0   = 6'h18,
    ADDR_NUM_POINTS_CTRL     = 6'h1c,
    ADDR_INPUT_R_DATA_0      = 6'h20,
    ADDR_INPUT_R_DATA_1      = 6'h24,
    ADDR_INPUT_R_CTRL        = 6'h28,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NUM_CLUSTERS_DATA_0: begin
                    rdata <= int_num_clusters[31:0];
                end
...
assign num_clusters  = int_num_clusters;
...
// int_num_clusters[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_num_clusters[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_NUM_CLUSTERS_DATA_0)
            int_num_clusters[31:0] <= (WDATA[31:0] & wmask) | (int_num_clusters[31:0] & ~wmask);
    end
end
