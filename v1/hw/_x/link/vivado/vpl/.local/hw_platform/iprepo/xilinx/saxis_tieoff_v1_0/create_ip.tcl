...
set_property name saxis_tieoff_v1_0 [ipx::current_core]
set_property display_name AXI_Stream_Slave_Tieoff [ipx::current_core]
set_property description {AXI Stream Slave Tieoff} [ipx::current_core]
