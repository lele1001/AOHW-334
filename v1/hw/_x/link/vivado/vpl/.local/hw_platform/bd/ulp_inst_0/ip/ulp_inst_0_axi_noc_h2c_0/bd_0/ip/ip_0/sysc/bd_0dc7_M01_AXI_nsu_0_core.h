...
//
//**********************************************************************
#ifndef _bd_0dc7_M01_AXI_nsu_0_core_h_
#define _bd_0dc7_M01_AXI_nsu_0_core_h_

#include "NOCSlaveUnitXtlm.h"
#include "properties.h"

class bd_0dc7_M01_AXI_nsu_0_core : public NOCSlaveUnitXtlm
{
public:
...
bd_0dc7_M01_AXI_nsu_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  ...
  virtual ~bd_0dc7_M01_AXI_nsu_0_core() = default;
