...
set_property name maxis_tieoff_v1_0 [ipx::current_core]
set_property display_name AXI_Stream_Master_Tieoff [ipx::current_core]
set_property description {AXI Stream Master Tieoff} [ipx::current_core]
