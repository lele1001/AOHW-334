...
HD_PWD='/home/users/eleonora.cabai/Documents/K-Means-AIE/hw/_x/link/vivado/vpl/prj/prj.runs/ulp_inst_0_axi_sc_plram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ulp_inst_0_axi_sc_plram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ulp_inst_0_axi_sc_plram_0.tcl
