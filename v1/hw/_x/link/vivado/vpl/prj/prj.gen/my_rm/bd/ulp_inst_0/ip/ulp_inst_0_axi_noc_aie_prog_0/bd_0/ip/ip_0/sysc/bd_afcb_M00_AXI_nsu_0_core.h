...
//
//**********************************************************************
#ifndef _bd_afcb_M00_AXI_nsu_0_core_h_
#define _bd_afcb_M00_AXI_nsu_0_core_h_

#include "NOCSlaveUnitXtlm.h"
#include "properties.h"

class bd_afcb_M00_AXI_nsu_0_core : public NOCSlaveUnitXtlm
{
public:
...
bd_afcb_M00_AXI_nsu_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  ...
  virtual ~bd_afcb_M00_AXI_nsu_0_core() = default;
