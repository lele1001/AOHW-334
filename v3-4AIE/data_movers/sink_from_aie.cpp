...
#pragma HLS pipeline II = 1
        ...
        float x = in_1.read();
        discard = in_2.read() + in_3.read() + in_4.read();
        ...
        float x_accum = in_1.read() + in_2.read() + in_3.read() + in_4.read();
        float y_accum = in_1.read() + in_2.read() + in_3.read() + in_4.read();
        discard = in_1.read() + in_2.read() + in_3.read() + in_4.read();
...
#pragma DATAFLOW
        ...
        compute(input_1, input_2, input_3, input_4, output, num_clusters);
    }
}
