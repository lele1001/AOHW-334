...
void compute(
	...
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out17,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out18,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out19,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out20,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out21,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out22,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out23,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out24,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out25,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out26,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out27,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out28,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out29,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out30,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out31,
	hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &out32)
{
...
extern "C"
{
	void setup_aie(
		...
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_17,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_18,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_19,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_20,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_21,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_22,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_23,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_24,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_25,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_26,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_27,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_28,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_29,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_30,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_31,
		hls::stream<ap_uint<sizeof(float) * 8 * COORDS_IN>> &s_32
		)
	{
// PRAGMA for stream
