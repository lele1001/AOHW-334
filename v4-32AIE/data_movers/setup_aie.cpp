	...
	hls::stream<ap_uint<sizeof(float) * 8 * 8>> &out32)
{
	...
	// Write the number of fake points for the thirty-second AIE
	int32_t fake_points_aie = hls::min(4, fake_points);
	int32_t fake_points_updated = fake_points - fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out32.write(tmp);

	// Write the number of fake points for the thirty-first AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out31.write(tmp);

	// Write the number of fake points for the thirtieth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;	
	tmp.range(127, 96) = fake_points_aie;
	out30.write(tmp);

	// Write the number of fake points for the twenty-ninth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out29.write(tmp);

	// Write the number of fake points for the twenty-eighth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out28.write(tmp);

	// Write the number of fake points for the twenty-seventh AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out27.write(tmp);

	// Write the number of fake points for the twenty-sixth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out26.write(tmp);

	// Write the number of fake points for the twenty-fifth AIE
	fake_points_aie = hls::min(4, fake_points_updated);	
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out25.write(tmp);

	// Write the number of fake points for the twenty-fourth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out24.write(tmp);

	// Write the number of fake points for the twenty-third AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out23.write(tmp);

	// Write the number of fake points for the twenty-second AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out22.write(tmp);

	// Write the number of fake points for the twenty-first AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out21.write(tmp);

	// Write the number of fake points for the twentieth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out20.write(tmp);

	// Write the number of fake points for the nineteenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out19.write(tmp);

	// Write the number of fake points for the eighteenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out18.write(tmp);

	// Write the number of fake points for the seventeenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out17.write(tmp);

	// Write the number of fake points for the sixteenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out16.write(tmp);

	// Write the number of fake points for the fifteenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out15.write(tmp);

	// Write the number of fake points for the fourteenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out14.write(tmp);

	// Write the number of fake points for the thirteenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out13.write(tmp);

	// Write the number of fake points for the twelfth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out12.write(tmp);

	// Write the number of fake points for the eleventh AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out11.write(tmp);

	// Write the number of fake points for the tenth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out10.write(tmp);

	// Write the number of fake points for the ninth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out9.write(tmp);

	// Write the number of fake points for the eighth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out8.write(tmp);

	// Write the number of fake points for the seventh AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out7.write(tmp);

	// Write the number of fake points for the sixth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out6.write(tmp);

	// Write the number of fake points for the fifth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out5.write(tmp);

	// Write the number of fake points for the fourth AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out4.write(tmp);

	// Write the number of fake points for the third AIE
	fake_points_aie = hls::min(4, fake_points_updated);
	fake_points_updated -= fake_points_aie;
	tmp.range(127, 96) = fake_points_aie;
	out3.write(tmp);
